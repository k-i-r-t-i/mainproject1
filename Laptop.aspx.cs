    ...
    public partial class Laptop : System.Web.UI.Page
    {
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            if (FileUpload1.HasFile)
            {
                ...
                {
                    FileUpload1.SaveAs(Server.MapPath("~/LaptopImages/") + str);
            ...
            con.Open();
            SqlCommand cmd = new SqlCommand("Insert into Laptoptb values('" + TextBox1.Text + "','" + TextBox2.Text + "','" + TextBox3.Text+ "','" + TextBox4.Text + "','" + TextBox5.Text + "','" + TextBox6.Text + "','" + TextBox7.Text + "','" + TextBox8.Text + "','" + TextBox9.Text + "','" + TextBox10.Text + "','" + TextBox11.Text + "','" + str + "','" + TextBox12.Text + "')", con);
            cmd.ExecuteNonQuery();
            con.Close();
            TextBox1.Text = "";
            TextBox2.Text = "";
